function funkcija_ar_datu_filtraciju
%% Funkcija ar datu filtrāciju atgriež vērtības pie noteikta laika
% Uzzīmēsim grafiku pie noteikta laika
t=0:0.01:4; % nosakam laiku intervālu
y=labdarbs3_atskaite(t); % uzģenerējam atbilstošās "y" vērtības
plot(t,y) % uzzīmējam grafiku
axis([0 5 -4 4]) % attālinam grafiku, lai nelīp pie malām
%% Palaižam funkciju un uzzīmējam visu labdarbu.
labdarbs3_atskaite;
%% Secinājums
% Grūtākais visā šajā darbā bija atrast T vērtību. Paturpināšu mājās
% secinājumu!!!
